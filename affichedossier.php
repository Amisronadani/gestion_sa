...
?>
    ...
    <a href="dossier2.php" class="ajouter">➕ Creer une compte</a>
        ...
        <tbody id="clientList">
            <?php foreach ($dossier as $dossier): ?>
                <tr>
                    ...
                    <td><img class="image" src="uploads/<?= htmlspecialchars($dossier['photo']) ?>" alt="Photo" style="max-width: 100px; max-height: 100px;"></td>
